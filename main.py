...
import cohere
co = cohere.Client('AjLh0IFke3oYIcUtLQjLsfy3ESoZ6m8tlWbt7CWu')

corpus = ['food is good', 'games are better', 'sports are the best']
query = 'what is the best'

results = co.rerank(query=query, documents=corpus, model='rerank-multilingual-v2.0')
print(results)